      ...
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20">Câu Cá Ốc Đảo</p>
            ...
            <form>
              ...
              <div className="mb-5">
                <input
                  ...
                  disabled={
                    validation.email ? true : validation.password ? true : false
                  }
                />
              </div>
              ...
              <button className="flex w-full items-center justify-center gap-3.5 mt-5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
