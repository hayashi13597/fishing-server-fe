...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 md:z-10 z-[9999] flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <div className="flex gap-3 items-center">
          ...
          <p className="text-xl text-white uppercase">Câu cá Ốc Đảo</p>
        </div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/tin-tuc"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    (pathname === "/tin-tuc" || pathname.includes("tin-tuc")) &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href="/hoa-don"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    (pathname === "/hoa-don" || pathname.includes("hoa-don")) &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
              ...
              <li>
                <Link
                  href="/lien-he"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    (pathname === "/lien-he" || pathname.includes("lien-he")) &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <div className="text-2xl">
