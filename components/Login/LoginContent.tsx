...
import { UpdateAccount } from "@/redux/account/AccountSlicer";
    ...
    onSubmit: (values) => {
      UserApi.login(values)
        .then((res: any) => {
          ...
          handleAttachToken(res.data.account.accessToken);
          router.push("/");
        })
        .catch((res) => {
              ...
              <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 ${
                        formik.errors.email
                          ? "outline-meta-1 border-meta-1"
                          : "outline-none border-stroke"
                    ...
                    />
                    {formik.errors.email && (
                      <p className="text-meta-1">{formik.errors.email}</p>
                    )}
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    />
                    {formik.errors.password && (
                      <p className="text-meta-1">{formik.errors.password}</p>
                    )}
                    <span className="absolute right-4 top-4">
                      <svg
                        className="fill-current"
